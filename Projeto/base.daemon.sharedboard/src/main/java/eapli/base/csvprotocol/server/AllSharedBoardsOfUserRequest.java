...
public class AllSharedBoardsOfUserRequest extends SharedBoardProtocolRequest {

    private final AuthorizationService authz;
    private final ReadWriteBoardsData readWriteBoardsData;
    private final byte messageCode = SBPMessageFormat.SBP_MESSAGE_CODE_ALL_BOARDS_OF_USER;

    protected AllSharedBoardsOfUserRequest(SBPMessageFormat inputRequest, AuthorizationService authz,
    ...
    protected SBPMessageFormat buildResponse() {
        ...
        ArrayList<Board> boards = (ArrayList<Board>) this.readWriteBoardsData.readVariousBoardsData(this.currentUser(),
                messageCode);
