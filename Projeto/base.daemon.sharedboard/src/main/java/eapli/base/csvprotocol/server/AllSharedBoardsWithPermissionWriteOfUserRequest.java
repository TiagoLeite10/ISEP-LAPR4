...
public class AllSharedBoardsWithPermissionWriteOfUserRequest extends SharedBoardProtocolRequest {

    private final AuthorizationService authz;
    private final ReadWriteBoardsData readWriteBoardsData;
    private final byte messageCode = SBPMessageFormat.SBP_MESSAGE_CODE_ALL_BOARDS_WITH_PERMISSION_WRITE_OF_USER;

    protected AllSharedBoardsWithPermissionWriteOfUserRequest(SBPMessageFormat inputRequest, AuthorizationService authz,
