...
/**
 * Classe para realizar testes à classe TakenExam.
 */
public class TakenExamTest {

    //Nota do exame
    private final Grade GRADE = Grade.valueOf(20F);
    ...
    /**
     * Método para contruir um exame feito.
     *
     * @return Um exame feito construída.
     */
    private TakenExam buildTakenExam() {
        return new TakenExam(GRADE, buildStudent(), buildExam());
    }
